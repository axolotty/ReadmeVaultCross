<script lang="ts">
  ...
  const resources = [
    { label: "Code source sur GitHub", url: "https://github.com/Axolotty/ReadmeVault" },
    { label: "Notes de version", url: "https://github.com/Axolotty/ReadmeVault/releases" },
    { label: "Signaler un problème", url: "https://github.com/Axolotty/ReadmeVault/issues" },
  ];
