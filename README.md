...
[![Build & Release](https://github.com/Axolotty/ReadmeVaultCross/actions/workflows/build.yml/badge.svg)](https://github.com/Axolotty/ReadmeVaultCross/actions/workflows/build.yml)
...
Rendez-vous sur la page [Releases](https://github.com/Axolotty/ReadmeVaultCross/releases) et téléchargez le fichier correspondant à votre système.
...
```bash
git clone https://github.com/Axolotty/ReadmeVaultCross.git
cd ReadmeVaultCross
npm install
```
...
Ouvre une [issue GitHub](https://github.com/Axolotty/ReadmeVaultCross/issues) avec :
- OS et version
